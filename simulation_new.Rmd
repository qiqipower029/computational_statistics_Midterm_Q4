...
prop.list=list(c(0.65, 0.80, 0.90), c(0.50, 0.80, 0.95))  # A list of probability vectors for ordinal variables. (cdf-cutoff)

A = gen.corr(1, n.P, n.B, n.O, lambda.vec, prop.vec, prop.list)
...
B = gen.corr(3, n.P, n.B, n.O, lambda.vec, prop.vec, prop.list)
