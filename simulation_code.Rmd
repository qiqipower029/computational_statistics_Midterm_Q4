...
simulation.function = function(parameteters, N, n.sim = 1000) {
  ...
  for (i in 1:n.sim) {
    ...
    t11_ci_low[i] = t11.mean-1.96*sqrt(t11.mean*(1-t11.mean)/N^2)
    t11_ci_high[i] = t11.mean+1.96*sqrt(t11.mean*(1-t11.mean)/N^2)
    ...
    t21_ci_low[i] = t21.mean-1.96*sqrt((prop01*(1-prop01)+prop11*(1-prop11)-2*prop01*prop11)/N^2)
    t21_ci_high[i] = t21.mean+1.96*sqrt((prop01*(1-prop01)+prop11*(1-prop11)-2*prop01*prop11)/N^2)
    t31_ci_low[i] = t31.mean-1.96*sqrt((prop01*(1-prop01)+prop11*(1-prop11)+prop21*(1-prop21)-2*prop01*prop11-2*prop11*prop21-2*prop01*prop21)/N^2)
    t31_ci_high[i] = t31.mean+1.96*sqrt((prop01*(1-prop01)+prop11*(1-prop11)+prop21*(1-prop21)-2*prop01*prop11-2*prop11*prop21-2*prop01*prop21)/N^2)
    t12_ci_low[i] = t12.mean-1.96*sqrt(t12.mean*(1-t12.mean)/N^2)
    t12_ci_high[i] = t12.mean+1.96*sqrt(t12.mean*(1-t12.mean)/N^2)
    t22_ci_low[i] = t22.mean-1.96*sqrt((prop02*(1-prop02)+prop12*(1-prop12)-2*prop02*prop12)/N^2)
    t22_ci_high[i] = t22.mean+1.96*sqrt((prop02*(1-prop02)+prop12*(1-prop12)-2*prop02*prop12)/N^2)
    t32_ci_low[i] = t32.mean-1.96*sqrt((prop02*(1-prop02)+prop12*(1-prop12)+prop22*(1-prop22)-2*prop02*prop12-2*prop12*prop22-2*prop02*prop22)/N^2)
    t32_ci_high[i] = t32.mean+1.96*sqrt((prop02*(1-prop02)+prop12*(1-prop12)+prop22*(1-prop22)-2*prop02*prop12-2*prop12*prop22-2*prop02*prop22)/N^2)
...
result.test = simulation.function(para1, 100, n.sim = 5)
```
